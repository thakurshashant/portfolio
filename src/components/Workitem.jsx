  ...
  return (
    <ol className="flex flex-col md:flex-row relative border-1 border-stone-200">
      <li className="mb-10 ml-4">
        <div className="absolue w-3 h-3 ng-stonne-200 rounded-full mt-1.5 -left-1.5 border-white" />
        <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-x5 md:text-sm  ">
          ...
          <span className="my-1 text-smal  font-normal leading-none text-stone-400">
            {duration}
          </span>
        </p>
